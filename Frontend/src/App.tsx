...
const games = [
  ...
  },
  {
    ...
    name: "Boodschappen",
    port: 3004,
    levelKey: "levelBoodschappen",
    extraParams: () => "",
  },
  {
    id: 5,
    name: "Voorwerpen Lokaliseren",
    port: 18888,
    levelKey: "levelVoorwerpenLokaliseren",
    extraParams: () => "",
  },
  {
    id: 6,
